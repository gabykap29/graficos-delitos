...
function drawChart1() {
  ...
  var chart = new google.visualization.ColumnChart(document.getElementById('chart_container1'));
...
function drawChart3() {
  ...
  var chart = new google.visualization.BarChart(document.getElementById('chart_container3'));
  chart.draw(data, options);
}
...
function drawChart4() {
  ...
  var chart = new google.visualization.ColumnChart(document.getElementById('chart_container4'));
  chart.draw(data, options);
}
...
function drawChart5() {
  ...
  var chart = new google.visualization.PieChart(document.getElementById('chart_container5'));
  chart.draw(data, options);
}
